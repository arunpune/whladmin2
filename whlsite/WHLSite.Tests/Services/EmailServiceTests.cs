...
public class EmailServiceTests
{
    ...
    public void ConstructorTests()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => new EmailService(null, null, null));
        Assert.Throws<ArgumentNullException>(() => new EmailService(_logger.Object, null, null));
        Assert.Throws<ArgumentNullException>(() => new EmailService(_logger.Object, _userRepository.Object, null));

        // Invalid Options
        var smtpSettingsOptions = Options.Create((SmtpSettings)null);
        Assert.Throws<ArgumentNullException>(() => new EmailService(_logger.Object, _userRepository.Object, smtpSettingsOptions));

        // Not Null
        var actual = new EmailService(_logger.Object, _userRepository.Object, _smtpSettingsOptions.Object);
    ...
    {
        var service = new EmailService(_logger.Object, _userRepository.Object, _smtpSettingsOptions.Object);
    ...
    public async Task SendEmailTests(string host, int port, string username, string password, string fromAddress, string toAddresses, string subject, string body, bool useAuth, string expectedCode)
    {
        ...
        var service = new EmailService(_logger.Object, _userRepository.Object, smtpSettingsOptions.Object);
