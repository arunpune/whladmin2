...
function fnToggleSaveAddressInfo() {
  ...
  var av = $('.whl-formfield-physicaladdressvalidated').val();
  ...
  var mav = $('.whl-formfield-mailingaddressvalidated').val();
  ...
  if (ai) {
    allowSubmission = (av !== undefined && av !== null && av.trim() === '1')
                        && (psl1 !== undefined && psl1 !== null && psl1.trim().length > 0)
    ...
    if (allowSubmission && mai) {
      allowSubmission = (mav !== undefined && mav !== null && mav.trim() === '1')
                          && (msl1 !== undefined && msl1 !== null && msl1.trim().length > 0)
...
$(function () {
  ...
  function fnToggleMailingAddresss() {
    ...
    if (vi) {
      ...
      $('.whl-formfield-mailingaddressvalidated').val('');
    } else {
      ...
      $('.whl-formfield-mailingaddressvalidated').val('1');
    }
  }

  $('.whl-formfield-physicaladdress').on('change', function (e) {
    $('.whl-formfields-physicaladdressvalidated').show();
    $('.whl-action-validate-physicaladdress').removeAttr('disabled');
    $('.whl-action-validate-physicaladdress').html('Validate');
    $('.whl-formfield-physicaladdressvalidated').val('');
    fnToggleSaveAddressInfo();
  });

  $('.whl-formfield-mailingaddress').on('change', function (e) {
    $('.whl-formfields-mailingaddressvalidated').show();
    $('.whl-action-validate-mailingaddress').removeAttr('disabled');
    $('.whl-action-validate-mailingaddress').html('Validate');
    $('.whl-formfield-mailingaddressvalidated').val('');
    fnToggleSaveAddressInfo();
  });
