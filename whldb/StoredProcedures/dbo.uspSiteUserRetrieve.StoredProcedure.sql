DROP PROCEDURE IF EXISTS [dbo].[uspSiteUserRetrieve];
GO
...
-- Description:	Retrieve a list of site users, or a single one by username
-- Examples:
--	EXEC dbo.uspSiteUserRetrieve (Retrieve All)
--	EXEC dbo.uspSiteUserRetrieve @Username = 'ADDRESS' (Retrieve One)
-- =============================================
CREATE PROCEDURE [dbo].[uspSiteUserRetrieve]
...
BEGIN
	...
	WHERE NULLIF(RTRIM(@Username), '') IS NULL OR U.Username = @Username
