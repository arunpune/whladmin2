DROP PROCEDURE IF EXISTS [dbo].[uspSiteListingUnitRetrieve];
GO
...
-- Examples:
--	EXEC dbo.uspSiteListingUnitRetrieve @ListingID = 1 (Retrieve All by Listing)
--	EXEC dbo.uspSiteListingUnitRetrieve @UnitID = 1 (Retrieve One)
-- =============================================
CREATE PROCEDURE [dbo].[uspSiteListingUnitRetrieve]
	@ListingID		INT = 0
	, @UnitID		INT = 0
AS
BEGIN
	...
	BEGIN
		...
		FROM dbo.tblSiteListingUnits U
