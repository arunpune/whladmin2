DROP PROCEDURE IF EXISTS [dbo].[uspSiteListingRetrieve];
GO
...
-- Examples:
--	EXEC dbo.uspSiteListingRetrieve (Retrieve All)
--	EXEC dbo.uspSiteListingRetrieve @ListingID = 1 (Retrieve One)
-- =============================================
CREATE PROCEDURE [dbo].[uspSiteListingRetrieve]
	@ListingID		INT = 0
AS
BEGIN
	SET NOCOUNT ON;
