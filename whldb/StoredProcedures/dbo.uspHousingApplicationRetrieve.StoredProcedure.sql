DROP PROCEDURE IF EXISTS [dbo].[uspHousingApplicationRetrieve];
GO
...
-- Description:	Retrieve a list of housing applications by listing ID, or a single one by application ID
-- Examples:
--	EXEC dbo.uspHousingApplicationRetrieve @ListingID = 1 (Retrieve All)
--	EXEC dbo.uspHousingApplicationRetrieve @ApplicationID = 1 (Retrieve One)
-- =============================================
CREATE PROCEDURE [dbo].[uspHousingApplicationRetrieve]
	@ListingID			INT = 0
